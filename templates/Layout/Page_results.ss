<div class="row">
    <div class="twelve columns">
        ...
        <% if $Results.MoreThanOnePage %>
            <ul class="pagination">
                <li class="arrow <% if $Results.NotFirstPage %><% else %>unavailable<% end_if %>"><a href="">&laquo;</a>
                </li>
                <% loop $Results.Pages(10) %>
                    <li class="<% if $CurrentBool %>current<% end_if %>"><a href="$Link">$PageNum</a></li>
                <% end_loop %>
                <li class="arrow <% if $Results.NotLastPage %><% else %>unavailable<% end_if %>"><a href="">&raquo;</a>
                </li>
            </ul>
        <% end_if %>
